...
test.beforeAll(async ({ request }) => {
  ...
  // register
  await request.post("http://ec2-98-93-8-168.compute-1.amazonaws.com:4080/api/auth/register", {
    data: { username: username1, password },
  });
  // login
  await request.post("http://ec2-98-93-8-168.compute-1.amazonaws.com:4080/api/auth/login", {
    data: { username: username1, password },
  });
});
...
test.describe("Puzzle Validation", () => {
  test("accepts correct answer", async ({ page }) => {
    await page.goto("http://ec2-98-93-8-168.compute-1.amazonaws.com/escape-room/1");
